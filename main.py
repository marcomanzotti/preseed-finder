...
from sources import yc, producthunt, antler, cordis
...
def main():
    ...
    parser.add_argument("--sources", default="yc,producthunt,antler,cordis", help="Fonti da usare, separate da virgola (default: yc,producthunt,antler,cordis)")
